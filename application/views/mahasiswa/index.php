...
<div class="row mt-3">
<div class="col-md-6">
      <a href="<?= base_url(); ?>mahasiswa/tambah" class="btn btn-danger">Tambah Data Mahasiswa</a>
</div>
</div>
...
<div class="row mt-3">
     ...
     <div class="row mt-3">
         ...
         <li class="list-group-item">
            ...
            <a href="<?= base_url (); ?>mahasiswa/ubah/<?=$mhs['id']; ?>" class="badge badge-primary float-right">ubah</a>
